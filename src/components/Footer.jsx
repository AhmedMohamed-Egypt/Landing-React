...
function Footer() {
  ...
  return (
    <ScrollSpy>
      <div className="footer-adrop pdtop-15 pdb-15" id="social">
      <div className="container-adrop">
        <div className="footer-adrop__container d-flex align-items-center justify-content-between">
          <p className="lightBlue size-16 nunito-reg">
            MR.Gain ©<span className="currentYear">{dateYear}</span>
            <span>- All Rights Reserved</span>
          </p>
          <div className="footer-adrop__container--privacyLinks">
            <a className="lightBlue size-16 nunito-reg" href="#">
              Terms &amp; Conditions
            </a>
            <a className="lightBlue size-16 nunito-reg mrl-30" href="#">
              Privacy Policy
            </a>
          </div>
